...
<table align="center" style="width:860px">
	<tr>
		<td style="text-align:center;border:1px solid black;width:50%; vertical-align:top;">
						...
						<li>
							<div class="listtitle">
								<a href="../board/view.jsp?menu=<%= vo.getMenu() %>&bno=<%= vo.getBno() %>">
									...
									{
										%>
										<span class="fontcolor">[<%= menuname %>]</span> <%= vo.getBtitle() %> <span class="fontcolor">(<%= vo.getRcount() %>)</span>
										<%
									}
									%>
								</a>
